        ...
        <div class="scroll-wrap">
            ...
            <div class="message">
                ...
                <div class="message-label">
                    <span class="tag all" :class="{'active':selectType===2}" @click="userSelectType(2)">全部<span class="num">15</span></span>
                    <span class="tag good" :class="{'active':selectType===0}" @click="userSelectType(0)">满意<span class="num">12</span></span>
                    <span class="tag bad" :class="{'active':selectType===1}" @click="userSelectType(1)">不满意<span class="num">20</span></span>
                </div>
                <div class="select">
                    ...
                    <li class="list-item" v-for="item in evaluate" v-show="showHide(item.rateType,item.text)">
                        ...
                        <div class="right-wrap">
                            <div class="name-wrap">
                                ...
                                <span class="date">{{dateJson(item.rateTime)}}</span>
                            </div>
...
export default {
    ...
    methods: {
        ...
        dateJson(dates) {
            let str = new Date();
            return str.getFullYear(dates) + '-' + (str.getMonth(dates) + 1) + '-' +
                str.getDate(dates) + " " + str.getHours(dates) + ':' +
                str.getMinutes(dates) + ':' + str.getSeconds(dates)
        },
        userClass() {
